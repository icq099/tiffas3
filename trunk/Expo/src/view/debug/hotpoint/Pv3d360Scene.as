package view.debug.hotpoint{
	...
	public class Pv3d360Scene extends Sprite {
		...
		//添加点击热点
		public function addHotPoint(init_obj:Object,tip_text:String="",icon:BitmapData=null):Plane{
			...
			var hot_point_material:BitmapMaterial=new BitmapMaterial(icon);
		...
		private function chageCompleteHandler(e:Event):void{
			...
			sphere.addEventListener(InteractiveScene3DEvent.OBJECT_CLICK,function(e:Event):void{
				...
				debugTrace("x=\""+int(_mouse3D.x)+"\"","y=\""+int(_mouse3D.y)+"\"","z=\""+int(_mouse3D.z)+"\"");
