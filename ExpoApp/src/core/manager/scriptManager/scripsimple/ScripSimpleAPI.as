package core.manager.scriptManager.scripsimple
{
	...
	public class ScripSimpleAPI
	{
		...
		public function apiExist(fun_name:String):Boolean
		{
			if(out_fun[fun_name]!=null)
			{
				return true;
			}
			return false;
		}
		internal function excuteFunctionByName(function_name:String,param:Array=null,wait:Boolean=false):*{
