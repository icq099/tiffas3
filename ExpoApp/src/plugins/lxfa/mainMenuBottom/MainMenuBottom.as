...
//			}
		...
		{
			if(MainSystem.getInstance().runAPIDirectDirectly(ScriptName.GETCAMERA)!=null)
			{
				tempFocus=MainSystem.getInstance().runAPIDirectDirectly(ScriptName.GETCAMERA).focus+focusSpeed;
				if(tempFocus<focusMaxRange)
				{
					MainSystem.getInstance().runAPIDirectDirectly(ScriptName.GETCAMERA).focus+=focusSpeed;
				}
			}
		}
		...
		private function cameraUpClickEvent(e:MouseEvent):void
		{
			if(MainSystem.getInstance().runAPIDirectDirectly(ScriptName.GETCAMERA)!=null)
			{
				MainSystem.getInstance().runAPIDirectDirectly(ScriptName.SETGOTOROTATION,[cameraRotateSpeed,0]);
			}
		}
		...
		private function cameraLeftClickEvent(e:MouseEvent):void
		{
			if(MainSystem.getInstance().runAPIDirectDirectly(ScriptName.GETCAMERA)!=null)
			{
				MainSystem.getInstance().runAPIDirectDirectly(ScriptName.SETGOTOROTATION,[0,-cameraRotateSpeed]);
			}
		}
